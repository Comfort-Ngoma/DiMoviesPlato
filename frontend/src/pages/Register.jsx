...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ⏳ Add a 2–3 second artificial delay before API call
    ...
    <div className="min-h-screen bg-gray-950 text-white mt-15 flex items-center justify-center py-20 px-6">
      <div className="w-full max-w-4xl bg-gray-900 border border-gray-700 rounded-xl shadow-xl p-10">
        <h2 className="text-2xl font-bold text-center text-white mb-6">
          Create Your
          <span className="text-sky-500 md:ml-1">DiMoviesPlato</span> Account
        </h2>
      ...
      {showSuccess && (
        <SuccessPopup
          message="Registration successful! Welcome to DiMoviesPlato."
