...
export default function Dashboard() {
  ...
  useEffect(() => {
    const user = JSON.parse(localStorage.getItem("dimoviesplatoUserInfo"));
    setUserInfo(user);
  }, []);

  const handleLogout = () => {
    localStorage.removeItem("dimoviesplato_token");
    localStorage.removeItem("dimoviesplatoUserInfo");
