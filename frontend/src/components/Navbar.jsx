          ...
          <Link to="/">
            <h1 className="text-xl sm:text-2xl font-bold text-white flex items-center">
              ...
              <div className=" -ml-4 -mb-1 sm:-ml-5 md:-ml-6">
                <span className="text-sky-500 md:ml-1">DiMoviesPlato</span>
              </div>
            </h1>
        ...
        <ul className="hidden md:flex items-center font-semibold text-white space-x-6 relative">
          {!isLoggedIn ? (
            ...
            <li className="relative flex items-center space-x-3">
              <Link
                to="/recommendations"
                className="px-5 py-2 bg-blue-500 hover:bg-gray-600 rounded-2xl transition duration-200 hover:scale-105">
                Recommendations
              </Link>
              <Link
                to="/watchlist"
              ...
              <div className="relative">
                <button
                  ...
                  className="px-5 py-2 bg-blue-500 cursor-pointer hover:bg-gray-600 rounded-2xl transition duration-200 hover:scale-105">
                  Dashboard ▾
                </button>
                {showDropdown && (
                  <ul
          ...
          {!isLoggedIn ? (
            <>
              <Link
                ...
                className="block bg-red-600 hover:bg-red-700 px-4 py-2 rounded-full text-center">
                Register
              </Link>
              <Link
                to="/login"
